...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Wait a frame so every other script's Start() (e.g. FlowerArea
        // populating its flower list) has finished before resetting agents
        StartCoroutine(DelayedMainMenu());
    }

    /// <summary>
    /// Waits one frame, then shows the main menu
    /// </summary>
